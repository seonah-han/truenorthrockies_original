...
Enable Google Analytics tracking by adding Global Site Tag Tracking code to your WordPress site.

== Description ==

[Global Site Tag Tracking](https://noorsplugin.com/global-site-tag-tracking-plugin-for-wordpress/) plugin makes Google Analytics tracking simpler and easier for WordPress. If you just want to activate Google Analytics on your website with minimal load on the server, all you need to do is enter your tracking ID in the plugin settings.
